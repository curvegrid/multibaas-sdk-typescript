...
**name** | **string** | The name of the contract in MultiBaas. | [optional] [default to undefined]
...
**verified** | **boolean** | Whether the contract has been verified. | [default to undefined]
...
**proxy** | **boolean** | Whether the contract is a proxy contract. | [default to undefined]
